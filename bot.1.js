...
(function() {
  ...
  pupOnline = function() {
    return API.sendChat("Bot Offline!");
  };
  ...
  themeCommand = (function(_super) {
    ...
    themeCommand.prototype.functionality = function() {
      var msg;
      msg = "Any type of Bass Mysic is allowed here. Including Dubstep, Complextro, Drum and Bass, ";
  ...
  roomHelpCommand = (function(_super) {
    ...
    roomHelpCommand.prototype.functionality = function() {
      var msg1;
      msg1 = "Welcome to the Music Nation! Create a playlist and populate it with songs from either YouTube or Soundcloud.  ";
  ...
  swapCommand = (function(_super) {
    ...
    swapCommand.prototype.functionality = function() {
      ...
      if (users.length === 2) {
        ...
        if (userRemove === false || userAdd === true) {
  ...
  overplayedCommand = (function(_super) {
    ...
    overplayedCommand.prototype.functionality = function() {
      return API.sendChat(" Rules, overplayed songs, contacts, and other things are located at http://pastebin.com/8wDyS5ue");
    };
  ...
  handleUserJoin = function(user) {
    ...
    return API.sendChat("/me: " + user.username + " Welcome To The ★ Radiant Music ★! Have Fun!! ");
  };
